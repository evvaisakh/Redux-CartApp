...
function Footer() {
  return (
    <>
      ...
      >
        <div className="footer-content d-flex justify-content-evenly w-100 flex-wrap mt-3">
          <div style={{ width: '400px' }} className="website">
            <h4 >
              <i className="fa-solid fa-truck-fast me-2"></i>E-Kart
            </h4>
            <h6>
          ...
          <div className="contact d-flex flex-column flex-wrap">
            ...
            <div className="icons mt-3 d-flex justify-content-between fs-5">
              ...
              <Link to={'https://react-bootstrap.github.io/'} style={{ textDecoration: 'none', color: 'white' }}><i className="fa-brands fa-x-twitter"></i> </Link>
              ...
              <Link to={'https://react-bootstrap.github.io/'} style={{ textDecoration: 'none', color: 'white' }}><i className="fa-brands fa-instagram"></i></Link>
              <Link to={'https://react-bootstrap.github.io/'} style={{ textDecoration: 'none', color: 'white' }}><i className="fa-brands fa-github"></i></Link>
            </div>
          </div>
        </div>
        <p>Copyright © 2024 E-Kart. Built with React.</p>
      </div>
    </>
  )
}
